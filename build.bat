...
@echo Compiling...
@clang++ -g -gcodeview picoblaze_compiler.cc -o picoblaze_compiler.o -c %CompilerFlags%
@lld-link.exe /debug  "picoblaze_compiler.o" /OUT:"picoblaze.exe" %LinkFlags% %LinkLibs%
